...
const char *
Scanner::TW    [] = { "", "Boolean", "break", "continue", "do", "else", "false", "function", "if", "in", "NaN",
					"Number", "null", "Object", "return", "String", "true", "typeof", "undefined", "var", "while", NULL };
...
Lex Scanner::get_lex () {
  enum    state { H, IDENT, NUMB, COM, COM2, COM3, SLSH, ALE, ALE2, PLUS, MINUS, AMP, PIPE, QUOTE };
  int     d, j;
  string  buf;
  state   CS = H;
  do {
